...
import { answerKey, loadPreparationTargets, requiredMissing, snapshotPreparation, type PreparationAnswers, type PreparationQuestion, type PreparationTarget } from '../lib/checkoutPreparation';
...
export default function CheckoutPage() {
  ...
  const weighted = (item: CartItem) => !isSliceItem(item) && (item.orderingMode === 'weight_only' || item.orderingMode === 'whole_or_weight' || item.pricingType === 'per_kg');
