-- Canonical supplier checkout enforcement.
--
-- No supplier, pricing, product or historical order data is created or changed.
-- Replaces place_sales_order with the exact currently-applied implementation,
-- adding only supplier/cost validation for normal product lines and combo
-- components.
